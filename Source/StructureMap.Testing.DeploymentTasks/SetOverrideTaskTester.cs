...
namespace StructureMap.Testing.DeploymentTasks
{
	...
	public class SetOverrideTaskTester
	{
		...
		public void SetAnOverrideOnTheDefaultProfile()
		{
			...
			XmlNode overrideNode = _document.DocumentElement.SelectSingleNode("Profile[@Name='Blue']/Override[@Type='something']");
		...
		public void SetAnOverrideOnANamedProfile()
		{
			...
			XmlNode overrideNode = _document.DocumentElement.SelectSingleNode("Profile[@Name='Green']/Override[@Type='something']");
			string actualKey = overrideNode.Attributes["DefaultKey"].InnerText;
		...
		public void SetAnOverrideOnANamedProfileIfTheOverrideNodeDoesNotExist()
		{
			...
			XmlNode overrideNode = _document.DocumentElement.SelectSingleNode("Profile[@Name='Red']/Override[@Type='something']");
			string actualKey = overrideNode.Attributes["DefaultKey"].InnerText;
		...
		public void SetAnOverrideOnANamedProfileIfTheProfileNodeDoesNotExist()
		{
			...
			XmlNode overrideNode = _document.DocumentElement.SelectSingleNode("Profile[@Name='Orange']/Override[@Type='something']");
			string actualKey = overrideNode.Attributes["DefaultKey"].InnerText;
