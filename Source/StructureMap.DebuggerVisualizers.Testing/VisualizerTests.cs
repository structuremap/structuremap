...
namespace StructureMap.DebuggerVisualizers.Testing
{
    ...
    public class VisualizerTests
    {
        ...
        {
            Assert.That(typeof (IHasTwoGenerics<string, int>).AsCSharp(t => t.FullName),
                        Is.EqualTo(
                            "StructureMap.DebuggerVisualizers.Testing.IHasTwoGenerics<System.String,System.Int32>"));
        }
        ...
        {
            Assert.That(typeof (IHasTwoGenerics<,>).AsCSharp(t => t.FullName),
                        Is.EqualTo("StructureMap.DebuggerVisualizers.Testing.IHasTwoGenerics<FIRST,SECOND>"));
        }
    }
}