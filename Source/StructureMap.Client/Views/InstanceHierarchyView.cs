...
namespace StructureMap.Client.Views
{
    ...
    public class InstanceHierarchyView : IViewPart, IConfigurationVisitor
    {
        ...
        public void HandleInstance(InstanceToken instance)
        {
            ...
            string pluginLink =
                string.Format("http://PluginType={0}:ConcreteKey={1}", instance.PluginTypeName, instance.ConcreteKey);
        ...
        {
            string text =
                string.Format("Property:  <b>{0}</b> ({1}) = {2}", property.PropertyName, property.PropertyType,
                              property.Value);
            _cell.AddText(text);
        }
        ...
        {
            string text =
                string.Format("Template Property:  <b>{0}</b> ({1}) = {2}", property.PropertyName, property.PropertyType,
        ...
        public void HandleReferenceChildProperty(ChildProperty property)
        {
            ...
            string defaultUrl =
                string.Format("http://PluginType={0}:InstanceKey={1}", property.PluginType, property.ReferenceKey);
