...
namespace StructureMap.Emitting
{
	...
	public class DynamicAssembly
	{
		...
		private void Init()
		{
			...
			assemName.Name = this.Name;
			assemName.Version = new Version(1, 0, 0, 0);
			assemName.CodeBase = this.Name;
			...
			module = assemBuilder.DefineDynamicModule(this.Name);
		}
		...
		{
			ClassBuilder newClass = new ClassBuilder(this.module, ClassName);
			this.storeClass(newClass);
			return newClass;
		}

		public ClassBuilder AddClass(string ClassName, Type superType)
		{
			ClassBuilder newClass = new ClassBuilder(this.module, ClassName, superType);
			this.storeClass(newClass);
			return newClass;
		}
