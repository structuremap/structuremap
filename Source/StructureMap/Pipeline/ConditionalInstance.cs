...
namespace StructureMap.Pipeline
{
    public class ConditionalInstance<T> : ExpressedInstance<ConditionalInstance<T>>
    {
        ...
        protected override ConditionalInstance<T> thisInstance { get { return this; } }
        ...
        #region Nested type: ConditionalInstanceExpression
        ...
        public class ConditionalInstanceExpression
        {
            ...
            public IsExpression<T> TheDefault { get { return new InstanceExpression<T>(i => _parent._default = i); } }
