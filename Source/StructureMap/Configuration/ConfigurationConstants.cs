namespace StructureMap.Configuration
{
	public class ConfigurationConstants
	{
		...
		public const string INVALID_PROPERTY_CAST = "Property value in the configured InstanceMemento could not be casted to the target type";
		...
		public const string MEMENTO_SOURCE_CANNOT_RETRIEVE  = "The configured MementoSource cannot retrieve InstanceMemento objects";
		public const string CONFIGURED_DEFAULT_KEY_CANNOT_BE_FOUND  = "The default instance key configured for this PluginFamily cannot be found";
		public const string PLUGIN_FAMILY_CANNOT_BE_FOUND_FOR_INSTANCE  = "No matching PluginFamily for the embedded memento in the <Instances> node";
		public const string PLUGIN_CANNOT_READ_CONSTRUCTOR_PROPERTIES  = "There was an error trying to determine the constructor arguments for a Plugin.  Check for missing dependencies of the concrete type.";
		public const string FATAL_ERROR  = "A fatal error in configuration is preventing StructureMap from functioning correctly";
