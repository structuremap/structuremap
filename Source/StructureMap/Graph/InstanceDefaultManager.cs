...
namespace StructureMap.Graph
{
	...
	public class InstanceDefaultManager : GraphObject
	{
		...
		public void ReadDefaultsFromPluginGraph(PluginGraph graph)
		{
			...
			{
				AddPluginFamilyDefault(family.PluginTypeName, family.DefaultInstanceKey);
			}
		}
		...
		public Profile CalculateDefaults(string machineName, string profileName)
		{
			...
			MachineOverride machine = this.GetMachineOverride(machineName);
			Profile profile = this.findCurrentProfile(profileName);
		...
		{
			string profileName = this.DefaultProfileName;
