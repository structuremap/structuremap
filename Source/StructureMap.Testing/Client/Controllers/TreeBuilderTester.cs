...
namespace StructureMap.Testing.Client.Controllers
{
	...
	public class TreeBuilderTester
	{
		...
		{
			FamilyToken family = new FamilyToken(new TypePath(this.GetType()), "", new string[0]);
			_builder.HandleFamily(family);

			TreeNodeExpectation expectation = new TreeNodeExpectation(family.PluginType, ViewConstants.PLUGINFAMILY, family);
		...
		{
			PropertyDefinition property = new PropertyDefinition("property1", "type1", PropertyDefinitionType.Constructor, ArgumentType.Primitive);
			_builder.HandlePropertyDefinition(property);

			TreeNodeExpectation expectation = new TreeNodeExpectation("property1", ViewConstants.PROPERTY_DEFINITION, property);
		...
		public void MementoSourceNode()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(ViewConstants.MEMENTO_SOURCE, ViewConstants.INSTANCE, source);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void InstanceNode()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(instance.InstanceKey, ViewConstants.INSTANCE, instance);
		...
		{
			PropertyDefinition definition = new PropertyDefinition("Property1", typeof(string).FullName, PropertyDefinitionType.Constructor, ArgumentType.Primitive);
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.PRIMITIVE_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		{
			PropertyDefinition definition = new PropertyDefinition("Property1", typeof(string).FullName, PropertyDefinitionType.Constructor, ArgumentType.Enumeration);
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.ENUMERATION_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void InlineChildPropertyNode()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.INLINE_CHILD_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void HandleDefaultChildProperty()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.DEFAULT_CHILD_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void HandleReferenceChildProperty()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.REFERENCE_CHILD_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}	
		...
		{
			PropertyDefinition definition = new PropertyDefinition("Prop1", typeof(string).FullName, PropertyDefinitionType.Constructor, ArgumentType.Primitive);

			_builder.HandlePropertyDefinition(definition);

			TreeNodeExpectation expectation = new TreeNodeExpectation(definition.PropertyName, ViewConstants.PROPERTY_DEFINITION, definition);
			expectation.Verify(_builder.LastNode);
		}
		...
		{
			PropertyDefinition definition = new PropertyDefinition("Prop1", typeof(IGateway).FullName, PropertyDefinitionType.Constructor, ArgumentType.ChildArray);
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.CHILD_ARRAY_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void HandleTemplateProperty()
		{
			...
			TreeNodeExpectation expectation = new TreeNodeExpectation(property.PropertyName, ViewConstants.TEMPLATE_PROPERTY, property);
			expectation.Verify(_builder.LastNode);
		}
		...
		public void BuildTree()
		{
			...
			foreach (GraphObjectNode familyNode in families.Nodes)
			{
				...
				Debug.WriteLine("");
				Debug.WriteLine(family.PluginType);
