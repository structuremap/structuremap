...
namespace StructureMap.Testing.Pipeline
{
    ...
    public class EnumerableInstanceTester
    {
        ...
        {
            EnumerableInstance.DetermineCoercion(typeof(System.Collections.Generic.IList<IWidget>)).ShouldBeOfType<ListCoercion<IWidget>>();
        }
        ...
        public void build_children_to_a_list()
        {
            ...
            var list = theInstance.Build(typeof (IList<IWidget>), new StubBuildSession()).ShouldBeOfType<List<IWidget>>();
