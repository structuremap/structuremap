...
namespace StructureMap.Testing.Configuration.Tokens
{
	...
	public class PluginTokenTester
	{
		...
		public void ReadProperties()
		{
			...
			PluginToken token = new PluginToken(new TypePath(typeof (PluginToken)), "concrete", DefinitionSource.Explicit);
		...
		public void CreateImplicitToken()
		{
			...
			PluginToken expected = new PluginToken(new TypePath(pluggedType), expectedConcreteKey, DefinitionSource.Implicit);
