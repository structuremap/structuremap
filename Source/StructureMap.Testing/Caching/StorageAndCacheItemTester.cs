...
namespace StructureMap.Testing.Caching
{
	...
	public class StorageAndCacheItemTester
	{
		...
		public void StoreAndRetrieveFromCloneStorageStrategy()
		{
			...
			Assert.IsFalse(object.ReferenceEquals(target1, target2));
		}

		[Test, ExpectedException(typeof (ApplicationException), "Type StructureMap.Testing.Caching.CacheTarget2 is does not implement the ICloneable interface")]
		...
		[Test, ExpectedException(typeof (ApplicationException), "Exception when trying to serialize type StructureMap.Testing.Caching.CacheTarget2")]
