...
namespace StructureMap.Testing.Container.Source
{
	...
	public class DirectoryXmlMementoSourceTester
	{
		...
		public void TestFixtureSetUp()
		{
			...
			string instance1 = "<Instance Key=\"Red\" Type=\"Color\"><Property Name=\"Color\" Value=\"Red\" /></Instance>";
			string instance2 = "<Instance Key=\"Blue\" Type=\"Color\"><Property Name=\"Color\" Value=\"Blue\" /></Instance>";
			string instance3 = "<Instance Key=\"Bigger\" Type=\"GreaterThan\"><Property Name=\"Attribute\" Value=\"MyDad\" /><Property Name=\"Value\" Value=\"10\" /></Instance>";
		...
		{
			DirectoryXmlMementoSource source = new DirectoryXmlMementoSource("NotARealDirectory", "xml", XmlMementoStyle.NodeNormalized);
			source.Validate();
		}
	}
}