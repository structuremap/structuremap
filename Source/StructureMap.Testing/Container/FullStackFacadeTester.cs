...
namespace StructureMap.Testing.Container
{
	...
	public class FullStackFacadeTester
	{
		...
		public void GetNamedWidgets()
		{
			...
			ConfigurationWidget confWidget = (ConfigurationWidget) ObjectFactory.GetNamedInstance(typeof (IWidget), "BigOne");
		...
		public void BuildAllInstances()
		{
			...
			System.Collections.IList list = manager.GetAllInstances(typeof(IWidget));
